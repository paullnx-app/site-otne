      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-foreground tracking-tight mb-6 leading-[1.1]">
            ...
            <span className="text-primary text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl block mt-1">
              empresas que querem crescer
            </span>
          </h1>

          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed">
            Se você já investe em site, conteúdo ou anúncios, mas sente que “o Google não funciona” para o seu negócio, o
            problema não é o canal — é a estratégia. Ajudamos empresários e gestores a organizarem o SEO de forma simples,
            técnica e orientada a resultados: mais visitas qualificadas, mais leads e mais vendas.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="#metodologia" className="w-full sm:w-auto">
            <Button
              variant="outline"
              size="lg"
              className="h-14 px-8 border-border text-foreground hover:bg-secondary rounded-xl text-lg w-full sm:w-auto shadow-sm bg-white"
            >
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <div className="relative inline-block group cursor-default">
            <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 to-secondary/20 rounded-xl blur opacity-0 group-hover:opacity-70 transition duration-500" />
            <div className="relative bg-white/60 backdrop-blur-md border border-black/5 rounded-xl py-4 px-6 text-sm md:text-base text-muted-foreground leading-relaxed shadow-sm">
              <span className="font-bold text-primary block md:inline md:mr-2 mb-1 md:mb-0">O que é SEO?</span>
              É organizar o seu site para que o Google entenda que você é a melhor resposta para o seu cliente, colocando
              sua empresa no topo das buscas.
            </div>
          </div>
        </div>
      </div>
